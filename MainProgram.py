...
if __name__ == "__main__":
	...
	all_site_deals.append(RE_Crowdfunding.RECrowdfundingSite(realtyshares_deal_urls, realtyshares_obj))

	crowdstreet_obj = CrowdStreet.CrowdStreet(selenium_session)
	crowdstreet_obj.login()
	crowdstreet_deal_urls = crowdstreet_obj.get_current_offering_urls()
	all_site_deals.append(RE_Crowdfunding.RECrowdfundingSite(crowdstreet_deal_urls, crowdstreet_obj))
	...
	for site in all_site_deals:
		for deal_url in site.deal_urls:
